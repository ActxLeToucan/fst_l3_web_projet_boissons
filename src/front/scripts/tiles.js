...
const COCKTAIL_TILE_BODY = `<div class="flex flex-col h-fit lg:w-[15em] lg:w-[12em] w-[8em]">
    <div class="flex flex-col grow">
        ...
        <div class="noimg-svg flex flex-col justify-center lg:w-60 lg:h-60 md:w-40 md:h-40 w-20 h-20 mx-auto text-slate-300">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="lg:w-20 lg:h-20 md:w-40 md:h-40 w-10 h-10 mx-auto">
